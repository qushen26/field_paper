...
Urban form means the features of urbanized human settlements or artificial agglomeration. 
In policy-oriented studies, urban-form features refer to some general characteristics described by some factors such as population, land use, road network structures. Each factor could have one or more measures like size, counts, density or distance.
That means an urban-form factor and its measures have the same meaning in different regions or urbanized areas. In contrast, the specific features such as Disneyland or Portland Greenways should be analyzed in project-oriented studies.
