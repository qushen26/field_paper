...
```{r Mstage,eval=T,echo=F,out.width='100%', fig.align='center',fig.cap="Multistage Structure"}
...
```{r Tree,eval=T,echo=F,out.width='100%', fig.align='center',fig.cap="Decision Tree Structure"}
# manypoint<- plot(rnorm(30),rnorm(30))
DiagrammeR::grViz("
digraph Tree {
graph[fontname = 'helvetica-bold',  nodesep=0.4, overlap='prism1000']
...
```{r Mscale,eval=T,echo=F,out.width='100%', fig.align='center',fig.cap="Multi-scales Structure"}
# manypoint<- plot(rnorm(30),rnorm(30))
DiagrammeR::grViz("
digraph Mscale {
...
node [shape = oval, style=filled, fillcolor = White, height = 0.75, width = 1, 
  ...
  subgraph cluster_U {
  label = 'Urban Form'; fillcolor= WhiteSmoke; 
     
    node [fillcolor = Beige];
    UT[label = 'City \\n Travel \\n Behavior'];		 

    subgraph cluster_BE{
    label = 'Built Environmnet'; fillcolor= PapayaWhip; 

      node [fillcolor = palegreen];
      NT[label = 'Neighborhood \\n Travel \\n Behavior'];
