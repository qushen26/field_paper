...
Adopted from some common usages, here 'urban form' refers to the comprehensive physical expression of land use at macro scale.  
'Built environment' emphasis the urban form attributes as a series of external factors with respect to travelers' internal characteristics.
When using 'urban form' and 'Built environment', one looks them as the given conditions of travel decision.
While 'land use' can represent either current status descriptions or designated future use at meso and micro scales.
...
Among the selected nine VMT-density studies in @ewingTravelBuiltEnvironment2010, eight use single city/metro data. 
...
)  , booktabs = TRUE, label = 'geoid', align = "llr", digit=2,
  caption = 'The Studies of VMT vresus Density in @ewingTravelBuiltEnvironment2010'
) %>% kable_classic(bootstrap_options = "striped",full_width = F,font_size = 7)  #%>% kable_styling( ) 
   #%>%footnote(symbol = c("Non-peer-reviewed", "Non-significant", 'not log transform,$R^2$=0.097'),footnote_as_chunk = T)
```

<!-- [^45]: @ewing2009measuring: Portland, elas=0.00;  -->
<!-- @frankMultipleImpactsBuilt2005 Misquote,Seattle , elas=0.00;  -->
<!-- @greenwald2009sacsim Sacramento, elas=-0.07 (Non-significant, Unpublished);  -->
<!-- @mariakockelmanTravelBehaviorFunction1997,Bay Area, elas=0.00;  -->
