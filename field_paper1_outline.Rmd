...
Urban form means the features of urbanized human settlements or artificial agglomeration. In policy-oriented studies, urban-form features refer to the general characteristics described by some factors such as density, mixed use, and road network structure. Each factor could have one or more measures like population, employment, or intersection. That means an urban-form factor and its measures have the same meaning in different regions or urbanized areas. In contrast, the specific features such as Disneyland or Portland Greenways should be analyzed in project-oriented studies.

Urban-form features can be divided as functional or morphological. Functional features refer to what people can do in urban areas, such as residing, working, recreation, and travel. Morphological features mean the distribution and organization of the functions. In gravity law, place mass is related to the functional features, and the morphological features decide distance. In the theory of intervening opportunities, the number of opportunities is determined by the urban functions, and the radium is related to morphology. In utility theory, the functional features benefit through activities, and the morphological features give the costs or impedance.

Travel and transportation system can be broadly interpreted as a part of the urban form. But in AD-urban form studies, travel pattern is the target. Transportation system belongs to the interest of transportation planning and policy. Therefore, AD-urban form studies need to distinguish travel and transportation from other urban forms.
...
In disaggregate studies, each case locates in a Block Group or Tract. The attributes of this Block Group or Tract are the urban-form treatments on this case. The regional measures are often not applicable for these scales.
