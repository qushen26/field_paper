# Land Use as an influencing factor

For the complexity of human behavior, many objective or subjective factors could change people's travel decisions, such as job opportunity, income level, lifecycle stage, habits, and preferences, etc. It seems impossible to make an exhaustive list.
After the meta-analysis of built environment and travel behavior by @ewingTravelBuiltEnvironment2010,
a recent update re-examines the post-2010 empirical literature and give a list.


## Mechanisim (Several Perspectives)
...
### Spatial Scales and Modifiable areal unit problem (MAUP)
